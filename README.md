...
- Poetry 2.x
 ...
 For the full dependency list, see [pyproject.toml](https://codeberg.org/PaZuFa/pazufa-collector-core/src/branch/main/pyproject.toml). 

## Setup 

See [SETUP.md](https://codeberg.org/PaZuFa/pazufa-collector-core/src/branch/main/SETUP.md) for the full setup guide, which is versioned alongside the code.

## Contribution

See [CONTRIBUTING.md](https://codeberg.org/PaZuFa/pazufa-collector-core/src/branch/main/CONTRIBUTING.md) for development setup, git workflow, code generation, documentation and project context.
