...
T = TypeVar("T", bound="KalGetResponse200")


@_attrs_define
class KalGetResponse200:
    """
    Attributes:
        body (list[Sitzung]):
        link (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kal_get_response_200.additional_properties = d
        return kal_get_response_200
